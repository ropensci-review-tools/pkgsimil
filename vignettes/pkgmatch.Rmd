...
And the "odbc" package does not even appear in terms of similarity in either
text or code. Results from other other component, comparing relative token
frequencies with all CRAN packages, including frequencies of code tokens, are:
